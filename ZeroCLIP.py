## From the paper Zero-Shot Image-to-Text Generation for Visual-Semantic Arithmetic [CVPR 2022]
...
class CLIPTextGenerator:
    ...
    def clip_loss(self, probs, context_tokens):
        ...
        for idx_p in range(probs.shape[0]):
            ...
            with torch.no_grad():
                similiraties = (self.image_features.float() @ text_features.T.float())
